...
class StudentApp(tk.Tk):
    def __init__(self):
        ...
        self.resizable(0,0)
        self.Title = tk.Label(self, text="Student Management System", font=("Helvetica", 16), fg="green")
        self.FName = tk.Label(self, text="Enter FirstName:", font=("Helvetica", 10), bg="white", fg="black")
        self.LName = tk.Label(self, text="Enter LastName:", font=("Helvetica", 10), bg="white", fg="black")
        self.ContactNo = tk.Label(self, text="Enter Contact No:", font=("Helvetica", 10), bg="white", fg="black")
        self.City = tk.Label(self, text="Enter City:", font=("Helvetica", 10), bg="white", fg="black")
        self.State = tk.Label(self, text="Enter State:", font=("Helvetica", 10), bg="white", fg="black")
        self.DOB = tk.Label(self, text="Choose Date of Birth:", font=("Helvetica", 10), bg="white", fg="black")
        self.Select = tk.Label(self, text="Please select one record below to update or delete", font=("Helvetica", 10), bg="white", fg="black")
        self.Search = tk.Label(self, text="Please Enter Row Number:",font=("Helvetica", 10), bg="white", fg="black")
        ...
        self.btn_exit = tk.Button(self, text="Exit", font=("Helvetica", 16), bg="brown", fg="white",command=self.exit)
        #Title of Table Show Student's Data
        columns = ("#1", "#2", "#3", "#4", "#5", "#6", "#7")
        self.tvStudent= ttk.Treeview(self,show="headings",height="5", columns=columns)
        self.tvStudent.heading('#1', text='Row Number', anchor='center')
        ...
        self.ContactNo.place(x=203, y=129,  height=23, width=104)
        self.City.place(x=242, y=158,  height=23, width=65)
        self.State.place(x=236, y=187,  height=23, width=71)
        self.DOB.place(x=180, y=217, height=23, width=128)
        ...
        self.entContact.place(x=330, y=129, height=21, width=186)
        self.entCity.place(x=330, y=158, height=21, width=186)
        self.entState.place(x=330, y=188, height=21, width=186)
        self.calDOB.place(x=330, y=218, height=21, width=186)
    ...
    def create_table(self):
        ...
        db_cursor.execute("create table if not exists Student_master(Id INT(11) NOT NULL  PRIMARY KEY AUTO_INCREMENT,rollno INT(15),fname VARCHAR(30),lname VARCHAR(30),city VARCHAR(20),state VARCHAR(30),mobileno VARCHAR(11),dob date)AUTO_INCREMENT=1")
        db_connection.commit()
